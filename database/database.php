 ...
 */
// require('./includes/class.logs.php');
require(dirname(__FILE__) . "/database-log.php");
class DB
{
	private $Host;
	private $DBName;
	...
	private function Connect(){
		try {
			...
			// $this->pdo = new PDO('mysql:dbname=' . $this->DBName . ';host=' . $this->Host . ';charset=utf8', $this->DBUser, $this->DBPassword,
			// 	array(
